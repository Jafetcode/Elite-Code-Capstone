...
function TeacherManageQuestion() {
  ...
  const getQuestionData = async () => {
    try {
      const res = await fetch(
        `https://elitecodecapstone24.onrender.com/instructor/getQuestion/?qid=${qid}`,
        {
          method: "GET",
          headers: {
  ...
  const handleUpdate = async () => {
    try {
      ...
      const res = await fetch(
        `https://elitecodecapstone24.onrender.com/instructor/updateQuestion/${qid}`,
        {
          method: "PUT",
          headers: {
      ...
      [
        { text: "Cancel", style: "cancel" },
        {
          ...
          onPress: async () => {
            try {
              const res = await fetch(
                `https://elitecodecapstone24.onrender.com/instructor/question/${qid}}`,
                {
                  method: "DELETE",
                }
              );
