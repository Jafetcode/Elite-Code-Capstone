        ...
        <ScrollView style={styles.scrollView}>
          <View style={styles.contentContainer}>
            ...
            <View style={styles.headerContainer}>
              <View style={styles.scoreSection}>
                <Text style={styles.scoreText}>
                  Score: <Text style={styles.scoreValue}>{responseData.score.points}/{responseData.score.total}</Text>
                </Text>
                <Text style={styles.percentageText}>
                  {responseData.score.percentage.toFixed(1)}%
                </Text>
              </View>
              <Text style={styles.dateText}>
                Submitted: {formatDate(responseData.submittedAt)}
              </Text>
            </View>
            ...
            <View style={styles.section}>
              ...
              <Text style={styles.questionText}>{responseData.question}</Text>
            ...
            <View style={styles.section}>
              ...
              <Text style={styles.responseText}>{responseData.studentResponse}</Text>
            </View>
            ...
            <View style={[styles.section, styles.commentsSection]}>
              ...
              <Text style={styles.commentsText}>{responseData.teacherComments}</Text>
            </View>
          </View>
        </ScrollView>
      </SafeAreaView>
